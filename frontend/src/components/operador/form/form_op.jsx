...
const formop = () => {
  ...
  return (
    ...
    <div className="relative flex min-h-screen w-screen bg-gradient-to-l from-[#E1EAF0] via-[#4187B5] to-[#2F688D] overflow-y-auto">
      ...
      <form
        className="bg-[#d9d9d9] border-[20px] border-[#3c3c3c] p-5 border-r-[20px] mt-[30px] ml-20 md:p-[40px_50px_0px_50px] w-[45%] max-w-[1000px] h-170" // Mantiene el tamaño original
      ...
      <form className="absolute right-[0] bg-[#d9d9d9] mt-[30px] border-[20px] border-l-[10px] mr-20 border-[#3c3c3c] p-5 md:p-[40px_50px_0px_50px] w-[45%] max-w-[1000px] h-170">
